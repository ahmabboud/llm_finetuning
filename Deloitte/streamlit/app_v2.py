...
path=os.getcwd()
tokenizer = AutoTokenizer.from_pretrained(f"models/llama-3-8b-chat-doctor-merged")
model = AutoModelForCausalLM.from_pretrained(f"models/llama-3-8b-chat-doctor-merged", device_map="auto") # to("cuda:0") 
terminators = [
